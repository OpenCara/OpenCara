...
- `opencara@0.25.2` published 2026-04-24 — CLI periodic heartbeat during tool execution (#782 via PR #788). Commit c374877. publish-cli.yml run 24884969212 success. Server-side #783 + #785 deploy via deploy-dev workflow.
